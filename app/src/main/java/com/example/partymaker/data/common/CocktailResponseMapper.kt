...
import com.example.partymaker.data.network.response.Cocktail
...
@Inject constructor(): ResponseMapper<CocktailDomain, Cocktail> {
    override fun mapToDomainModel(externalModel: Cocktail): CocktailDomain {
