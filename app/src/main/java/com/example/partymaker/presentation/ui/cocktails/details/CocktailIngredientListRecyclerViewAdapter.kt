...
class CocktailIngredientListRecyclerViewAdapter(
    private val ingredientsWithMeasures: MutableList<Pair<String, String>>
) : RecyclerView.Adapter<CocktailIngredientListRecyclerViewAdapter.ViewHolder>() {
...
private const val TAG = "CocktailIngredientListRecyclerV"
